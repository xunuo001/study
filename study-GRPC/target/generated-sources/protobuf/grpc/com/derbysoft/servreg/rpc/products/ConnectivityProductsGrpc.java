...
public final class ConnectivityProductsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.derbysoft.servreg.rpc.products.GetProductsRequest,
      com.derbysoft.servreg.rpc.products.GetProductsResponse> getGetProductsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProducts",
      requestType = com.derbysoft.servreg.rpc.products.GetProductsRequest.class,
      responseType = com.derbysoft.servreg.rpc.products.GetProductsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.derbysoft.servreg.rpc.products.GetProductsRequest,
      com.derbysoft.servreg.rpc.products.GetProductsResponse> getGetProductsMethod() {
    io.grpc.MethodDescriptor<com.derbysoft.servreg.rpc.products.GetProductsRequest, com.derbysoft.servreg.rpc.products.GetProductsResponse> getGetProductsMethod;
      ...
      synchronized (ConnectivityProductsGrpc.class) {
        if ((getGetProductsMethod = ConnectivityProductsGrpc.getGetProductsMethod) == null) {
          ConnectivityProductsGrpc.getGetProductsMethod = getGetProductsMethod =
              io.grpc.MethodDescriptor.<com.derbysoft.servreg.rpc.products.GetProductsRequest, com.derbysoft.servreg.rpc.products.GetProductsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetProducts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.derbysoft.servreg.rpc.products.GetProductsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.derbysoft.servreg.rpc.products.GetProductsResponse.getDefaultInstance()))
  ...
  public static abstract class ConnectivityProductsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getProducts(com.derbysoft.servreg.rpc.products.GetProductsRequest request,
        io.grpc.stub.StreamObserver<com.derbysoft.servreg.rpc.products.GetProductsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.derbysoft.servreg.rpc.products.GetProductsRequest,
                com.derbysoft.servreg.rpc.products.GetProductsResponse>(
  ...
  public static final class ConnectivityProductsBlockingStub extends io.grpc.stub.AbstractStub<ConnectivityProductsBlockingStub> {
    ...
    /**
     */
    public com.derbysoft.servreg.rpc.products.GetProductsResponse getProducts(com.derbysoft.servreg.rpc.products.GetProductsRequest request) {
  ...
  public static final class ConnectivityProductsFutureStub extends io.grpc.stub.AbstractStub<ConnectivityProductsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.derbysoft.servreg.rpc.products.GetProductsResponse> getProducts(
        com.derbysoft.servreg.rpc.products.GetProductsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCTS:
          serviceImpl.getProducts((com.derbysoft.servreg.rpc.products.GetProductsRequest) request,
              (io.grpc.stub.StreamObserver<com.derbysoft.servreg.rpc.products.GetProductsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConnectivityProductsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.derbysoft.servreg.rpc.products.ConnectivityProductsPB.getDescriptor();
    }
