...
stub = GreeterGrpc.newStub(channel).build(channel, callOptions);
    ...
    public io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloRequest> savHelloStream(io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply> responseObserver) {
    return stub
    .withDeadlineAfter(url.getParameter(TIMEOUT_KEY, DEFAULT_TIMEOUT), TimeUnit.MILLISECONDS)
    .savHelloStream(responseObserver);
    }
}
...
this.proxiedImpl = proxiedImpl;
    ...
    throw new UnsupportedOperationException("No need to override this method, extend XxxImplBase and override all methods it allows.");
        ...
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply> responseObserver) {
        return asyncUnimplementedStreamingCall(io.grpc.examples.helloworld.GreeterGrpc.getSavHelloStreamMethod(), responseObserver);
        }
...
return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
    ...
    .addMethod(
    io.grpc.examples.helloworld.GreeterGrpc.getSavHelloStreamMethod(),
    asyncBidiStreamingCall(
    new MethodHandlers<
    io.grpc.examples.helloworld.HelloRequest,
    io.grpc.examples.helloworld.HelloReply>(
    proxiedImpl, METHODID_SAV_HELLO_STREAM)))
.build();
}
}
    ...
    <Req> invoke(io.grpc.stub.StreamObserver
        <Resp> responseObserver) {
            switch (methodId) {
                ...
                <Req>) serviceImpl.savHelloStream(
                    (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply>) responseObserver);
            default:
            throw new java.lang.AssertionError();
            }
