...
public class GrpcGreeterImpl extends DubboGreeterGrpc.GreeterImplBase {
    ...
    @Override
    public StreamObserver<HelloRequest> savHelloStream(StreamObserver<HelloReply> responseObserver) {
        ...
        return new StreamObserver<HelloRequest>() {
            ...
            public void onCompleted() {
                HelloReply reply = HelloReply.newBuilder().setMessage("complated " ).build();
                responseObserver.onNext(reply);
            }
        };
